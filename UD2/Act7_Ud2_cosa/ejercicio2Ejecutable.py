...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.pushButton_3.clicked.connect(self.boton_uno)
        self.pushButton_2.clicked.connect(self.boton_dos)
        self.pushButton_4.clicked.connect(self.boton_tres)
        self.pushButton.clicked.connect(self.boton_cuatro)

    # llamada de la función mostrar mensaje según el boton que se muestra
    def boton_uno(self):
